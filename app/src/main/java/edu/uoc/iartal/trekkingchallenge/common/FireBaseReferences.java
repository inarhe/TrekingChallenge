...
public class FireBaseReferences {
    ...
    final public static String USER_ID_REFERENCE = "idUser";
    final public static String USER_NAME_REFERENCE = "userName";
    ...
    final public static String USER_PASSWORD_REFERENCE = "userPassword";
